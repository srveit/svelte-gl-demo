...
var app = (function () {
    ...
    // (38:2) <GL.OrbitControls maxPolarAngle={Math.PI} let:location>
    function create_default_slot_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_default_slot_2.name, type: "slot", source: "(38:2) <GL.OrbitControls maxPolarAngle={Math.PI} let:location>", ctx });
    	return block;
    }

    // (77:2) <GL.Group location={[light.x,light.y,light.z]}>
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_default_slot_1.name, type: "slot", source: "(77:2) <GL.Group location={[light.x,light.y,light.z]}>", ctx });
    	return block;
    }
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		...
    		p: function update(changed, ctx) {
    			...
    			var gl_mesh1_changes = {};
    			if (changed.h) gl_mesh1_changes.location = [0,ctx.h/2,0];
    			if (changed.w || changed.h || changed.d) gl_mesh1_changes.scale = [ctx.w,ctx.h,ctx.d];
    			if (changed.color) gl_mesh1_changes.uniforms = { color: ctx.from_hex(ctx.color) };
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_default_slot.name, type: "slot", source: "(35:0) <GL.Scene>", ctx });
    	return block;
    }
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input0, file$1, 88, 4, 1882);
    			add_location(label0, file$1, 87, 2, 1870);
    			attr_dev(input1, "type", "range");
    			attr_dev(input1, "min", 0.1);
    			attr_dev(input1, "max", 5);
    			attr_dev(input1, "step", 0.1);
    			add_location(input1, file$1, 92, 4, 1969);
    			add_location(label1, file$1, 91, 2, 1957);
    			attr_dev(input2, "type", "range");
    			attr_dev(input2, "min", 0.1);
    			attr_dev(input2, "max", 5);
    			attr_dev(input2, "step", 0.1);
    			add_location(input2, file$1, 96, 4, 2072);
    			add_location(label2, file$1, 95, 2, 2060);
    			attr_dev(input3, "type", "range");
    			attr_dev(input3, "min", 0.1);
    			attr_dev(input3, "max", 5);
    			attr_dev(input3, "step", 0.1);
    			add_location(input3, file$1, 100, 4, 2176);
    			add_location(label3, file$1, 99, 2, 2164);
    			attr_dev(div, "class", "controls svelte-py1ens");
    			add_location(div, file$1, 86, 0, 1845);
    		...
    		p: function update(changed, ctx) {
    			...
    			if (changed.$$scope || changed.h || changed.w || changed.d || changed.color) gl_scene_changes.$$scope = { changed, ctx };
