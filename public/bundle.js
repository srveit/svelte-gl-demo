...
var app = (function () {
    ...
    function create_fragment$9(ctx) {
    	...
    	var gl_mesh0 = new Index({
    		...
    		rotation: [0,-20,0],
    		scale: [w,h,d],
    		uniforms: { color: ctx.from_hex(color) }
    	},
    		$$inline: true
    	});
    ...
    class Cube extends SvelteComponentDev {
    	constructor(options) {
    		...
    		dispatch_dev("SvelteRegisterComponent", { component: this, tagName: "Cube", options, id: create_fragment$9.name });
    	}
    }
    ...
    // (67:2) <GL.Group location={[light.x,light.y,light.z]}>
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_default_slot_1.name, type: "slot", source: "(67:2) <GL.Group location={[light.x,light.y,light.z]}>", ctx });
    	return block;
    }
    ...
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_default_slot.name, type: "slot", source: "(36:0) <GL.Scene>", ctx });
    	return block;
    }
    ...
    function create_fragment$a(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input0, file$1, 78, 4, 1596);
    			add_location(label0, file$1, 77, 2, 1584);
    			attr_dev(input1, "type", "range");
    			attr_dev(input1, "min", 0.1);
    			attr_dev(input1, "max", 5);
    			attr_dev(input1, "step", 0.1);
    			add_location(input1, file$1, 82, 4, 1683);
    			add_location(label1, file$1, 81, 2, 1671);
    			attr_dev(input2, "type", "range");
    			attr_dev(input2, "min", 0.1);
    			attr_dev(input2, "max", 5);
    			attr_dev(input2, "step", 0.1);
    			add_location(input2, file$1, 86, 4, 1786);
    			add_location(label2, file$1, 85, 2, 1774);
    			attr_dev(input3, "type", "range");
    			attr_dev(input3, "min", 0.1);
    			attr_dev(input3, "max", 5);
    			attr_dev(input3, "step", 0.1);
    			add_location(input3, file$1, 90, 4, 1890);
    			add_location(label3, file$1, 89, 2, 1878);
    			attr_dev(div, "class", "controls svelte-py1ens");
    			add_location(div, file$1, 76, 0, 1559);
    ...
    class App extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$a, create_fragment$a, safe_not_equal, ["color"]);
